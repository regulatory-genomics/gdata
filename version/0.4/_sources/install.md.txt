...
The [nightly release](https://github.com/regulatory-genomics/genomics-dataloader/releases/tag/nightly) page
...
```
pip install gdata-x.x.x-cp38-cp38-manylinux_2_17_x86_64.manylinux2014_x86_64.whl
```

Build from the latest source code 
---------------------------------

Building the "genomics-dataloader" library requires the [Rust](https://www.rust-lang.org/tools/install) compiler.
...
Once you have the Rust compiler properly installed, you can use pip to install the genomics-dataloader library:
