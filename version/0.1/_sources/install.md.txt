...
Stable versions of gdata are published on PyPI.
...
The [nightly release](https://github.com/regulatory-genomics/gdata/releases/tag/nightly) page
...
Building the gdata library requires the [Rust](https://www.rust-lang.org/tools/install) compiler.
...
Once you have the Rust compiler properly installed, you can use pip to install the gdata library:
