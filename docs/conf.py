...
import gdata 
from gdata import utils
sys.modules['gdata.utils'] = utils

# -- Software version --------------------------------------------------------

# The short X.Y version (including .devXXXX, -devXXXX, rcX, b1 suffixes if present)
version = re.sub(r'(\d+\.\d+)\.\d+([-\.].*)?', r'\1\2', gdata.__version__)
version = re.sub(r'([-\.]dev\d+).*?$', r'\1', version)

# The full version, including alpha/beta/rc tags.
release = gdata.__version__
...
print(f'Building documentation for gdata {release} (short version: {version}, switcher version: {switcher_version})')
